...
const statusDevice = navigator.userAgent;
...
if(typeof(navigator.getBattery) === "function"){
    navigator.getBattery().then(function (battery){
        ...
        function updateDischarginInfo(){
            ...
            }else if(!battery.dischargingTime || !statusDevice.match('Windows')){
...
//********************************************** другой плагин
    ...
    document.querySelector('.not-supported').innerHTML = 'Ваш браузер не поддерживает данную функцию';
}
